...
function fixture(port) {
  return '<!doctype html><html lang="ru"><head>'
    ...
    + 'window.initializeCurrencyCalculator=()=>{const from=document.getElementById("currencySelectFrom"),to=document.getElementById("currencySelectTo"),a=document.getElementById("currencyAmountFrom"),b=document.getElementById("currencyAmountTo"),r=document.getElementById("currencyRateDisplay");if(from&&to&&!from.options.length){from.innerHTML="<option value=\\"USD\\">USD - Доллар США</option><option value=\\"RUB\\">RUB - Российский рубль</option><option value=\\"EUR\\">EUR - Евро</option>";to.innerHTML=from.innerHTML;from.value="USD";to.value="RUB";if(a)a.value="100";if(b)b.value="9240.50";if(r)r.textContent="1 USD ≈ 92.405 RUB";}};'\n    + 'window.alert=()=>{};window.confirm=()=>true;window.prompt=()=>"";'
    + '})();<\/script>'
    + '</head><body>'
